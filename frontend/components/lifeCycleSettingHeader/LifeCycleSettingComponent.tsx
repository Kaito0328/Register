...
export const LifecycleSettingComponent: React.FC<Props> = ({
  ...
  return (
    <BaseView style={styles.container} styleKit={{color: {colorKey: CoreColorKey.Danger, not_bg: true}}}>
      <View style={styles.customContainer}>
        <BaseTextInput
          style={[styles.input]}
          styleKit={{color: {colorKey: isCustomInputEditable ? CoreColorKey.Primary : CoreColorKey.Secondary}}}
          value={value}
